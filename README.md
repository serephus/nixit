...
owner must be an administrator of the repository. Rulesets on private
repositories additionally require a paid plan (GitHub Pro/Team/Enterprise); they
are available on public repositories for free.
...
| --- | --- | --- |
| **Administration** | Read and write | repository settings, topics, Actions permissions, rulesets, and creating repositories |
...
and rulesets) for both public and private repositories.
...
commit yourself. Rulesets and other settings are applied on the next run.
